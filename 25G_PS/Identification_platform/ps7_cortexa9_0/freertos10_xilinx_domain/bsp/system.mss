...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_dma_adc
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = iq_demodulator_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ad_fifo_monitor_axi
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = ad_fifo_monitor_axi_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.1
 PARAMETER HW_INSTANCE = ddc_stream_0
END
